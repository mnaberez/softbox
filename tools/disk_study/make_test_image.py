...
if __name__ == '__main__':
    ...
    headers = (
        ";This file was generated by make_test_image.py",
        ";Identifier is the unique number written into each sector half",
        ";All numbers in hexadecimal",
        ";",
        ";PET Track, PET Sector, PET Sector Half (0 or 1), Identifier",
        )
