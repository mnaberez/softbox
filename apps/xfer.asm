...
;
    ...
    db "RU",80h+"N"     ;RUN
    db "I",80h+"F"      ;IF
    db "RESTOR",80h+"E" ;RESTORE
    db "GOSU",80h+"B"   ;GOSUB
    db "RETUR",80h+"N"  ;RETURN
    db "RE",80h+"M"     ;REM
    db "STO",80h+"P"    ;STOP
    db "O",80h+"N"      ;ON
    db "WAI",80h+"T"    ;WAIT
    ...
    db "MID",80h+"$"    ;MID$
    db "G",80h+"O"      ;GO
    db "CONCA",80h+"T"  ;CONCAT
    db "DOPE",80h+"N"   ;DOPEN
    db "DCLOS",80h+"E"  ;DCLOSE
    db "RECOR",80h+"D"  ;RECORD
    db "HEADE",80h+"R"  ;HEADER
    db "COLLEC",80h+"T" ;COLLECT
    db "BACKU",80h+"P"  ;BACKUP
    db "COP",80h+"Y"    ;COPY
    db "APPEN",80h+"D"  ;APPEND
    db "DSAV",80h+"E"   ;DSAVE
    db "DLOA",80h+"D"   ;DLOAD
    db "CATALO",80h+"G" ;CATALOG
    db "RENAM",80h+"E"  ;RENAME
    db "SCRATC",80h+"H" ;SCRATCH
    db "DIRECTOR",80h+"Y" ;DIRECTORY
