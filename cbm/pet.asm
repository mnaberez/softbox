...
scroll_dn_y = $1f     ;Top Y position in the generated scroll down code
clear_eos_y = $20     ;Top Y position in the generated clear to EOS code
...
;Generated code for fast screen scroll down (175 bytes, see gen_scroll_up)
